...
public class AttributeMetaDataRepositoryDecorator implements Repository
{
	...
	{
		MetaValidationUtils.validateName(entity.getString(AttributeMetaDataMetaData.NAME));
		String identifier = entity.getString(AttributeMetaDataMetaData.IDENTIFIER);

		// Get entity this attributes belong to
		Entity entityMeta = dataService.query(EntityMetaDataMetaData.ENTITY_NAME)
				.eq(EntityMetaDataMetaData.ATTRIBUTES, identifier).findOne();
		if (entityMeta != null)
		{
