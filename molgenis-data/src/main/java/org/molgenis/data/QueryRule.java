...
public class QueryRule
{
	...
	public enum Operator
	{
		...
		NOT("!="),
		/**
		 * limit results to 'value' elements (value being an int). The paramater 'field' is ommitted.
		 */
		LIMIT("LIMIT"),
		/**
		 * show results from value-th element (value being an int offset starting from 1. The paramater 'field' is
		 * ommitted.
		 */
		OFFSET("OFFSET"),
		/**
		 * order the result by 'field', ascending. The parameter 'value' is ommitted.
		 */
		SORTASC("SORTASC"),
		/**
		 * order the result by 'field', descending. The parameter 'value' is ommitted.
		 */
		SORTDESC("SORTDESC"),
		/**
		 * AND operation
